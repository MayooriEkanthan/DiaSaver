...
function Prevention() {
  return (
    <div>
      ...
      <p>Learn about healthy food habits, exercise routines, and other lifestyle changes to prevent diabetes.</p> */}

      <div className="predi">
        <h2>Diabetes Prevention Tips</h2>

          <div class="grid">
    <div class="item item-0"><div className="predi1"> <h4>For Diabetic Patients</h4>
        <p>
          ...
          or light aerobics. Also, remember to care for your feet, manage stress effectively, and schedule regular health
          check-ups.
        </p></div> </div>
      <div class="item item-1"><div className="predi1"> <h4>For Everyone</h4>
        <p>
      ...
      <div class="item item-2"><div className="predi1"> <h4>For the General Population</h4>
        <p>
          ...
          and consider regular health screenings. Encouraging these habits in your children and family members builds a healthier
          future for everyone.
        </p></div></div>
      <div class="item item-3">
       <div className="predi1"> <h4>For People at Risk of Diabetes</h4>
        <p>
          ...
          sugar and refined carbs can significantly reduce your risk. Choose fiber-rich foods, quit smoking, drink more water,
          and ensure you're getting enough restful sleep. Don’t forget to check your blood sugar levels regularly.
        </p></div></div>
